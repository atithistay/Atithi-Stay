              ...
              <div className="flex items-center">
                ...
                <h3 className="font-medium text-gray-800">
                  {room.type === "single"
                    ...
                    : room.type === "common"
                    ? "Common Bedroom"
                    : room.type === "master_double"
                    ? "Master Bedroom Double Sharing"
                    : room.type === "common_double"
                    ? "Common Bedroom Double Sharing"
                    : `${room.type} Sharing`}
                </h3>
              </div>
            ...
            <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="flex items-center text-gray-600">
                ...
                <span className="text-sm">
                  {room.furnishing === "fully_furnished"
                    ? "Fully Furnished"
                    : room.furnishing === "semi_furnished"
                    ? "Semi Furnished"
                    : "Unfurnished"}
                </span>
              </div>
              ...
              <div className="mt-6 pt-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-gray-800">
                    {room.deposit?.type === "fixed"
                      ? `₹${room.deposit.amount.toLocaleString("en-IN")}`
                      : `${room.deposit.amount} month's rent`}
                  </span>
                </div>
                {room.deposit.refundable && (
                  <p className="text-sm text-gray-500 mt-1">
                    Refundable at the time of vacating
                  </p>
                )}
              </div>
            )}
